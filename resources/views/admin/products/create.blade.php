...
<div class="container">
    ...
    <form action="{{route('admin.products.store')}}"  method="post" enctype="multipart/form-data" id="form-group">
        @csrf()
        ...
        <div class="row">
                ...
                <div class="form-group offset-md-3">
                    <div class="row" style="display: inline-grid;">
                        ...
                        <div class="mt-3 choose-avatar">
                            <div id="btnimage">
                                <img id="showImage" class="show-avatar" src="#" alt="avatar">
                            </div>
                            <div id="button">
            ...
            <div class="col-md-8">
                ...
                <div class="form-group">
                    ...
                    <select id="create-category" name="category_id" class="form-control js-example-basic-multiple create_category @error('category') is-invalid @enderror" >
                        <option value=""></option>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input value="{{ old('specifications') }}"
                ...
                <div class="form-group">
                    ...
                    <textarea value="{{old('description')}}" class="form-control @error('description') is-invalid @enderror" id="exampleFormControlTextarea1" rows="3" name="description"></textarea>
                ...
                <div class="form-group text-center m-0 p-0 pt-5 pb-5">
                    <button type="submit" class="btn btn-success">{{__('labels.btn-create')}}</button>
...
<script src="{{asset('js/createProduct.js')}}" defer></script>
